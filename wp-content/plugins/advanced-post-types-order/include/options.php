        ...
        (..your code..)          
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td>
                                                ...
                                                <p><?php _e('You can still force certain queries to use your order (i.e. random) by using the force_no_custom_order query parameter', 'cpt') ?></p>
                                                <p><a href="javascript:;" onclick="jQuery('#example1').slideToggle();;return false;">Show Example</a></p>
