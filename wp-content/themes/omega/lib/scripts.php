...
function roots_scripts()
{
	...
	wp_enqueue_style('ptsans', get_template_directory_uri() . '/assets/fonts/pt-sans/stylesheet.css', null);
	wp_enqueue_style('play', get_template_directory_uri() . '/assets/fonts/play/stylesheet.css', null);
	wp_enqueue_style('font_awesome', get_template_directory_uri() . '/assets/fonts/font-awesome/css/font-awesome.min.css');
