...
function roots_widgets_init() {
	...
	register_sidebar(array(
		'name' => __('Header Stripe', 'roots'),
		'id' => 'sidebar-header-stripe',
	...
	register_sidebar(array(
		'name' => __('Footer Section 1', 'roots'),
		'id' => 'sidebar-footer-section-1',
		'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
		'after_widget' => '</div></section>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'name' => __('Footer Section 2', 'roots'),
		'id' => 'sidebar-footer-section-2',
		'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
		'after_widget' => '</div></section>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'name' => __('Footer Section 3', 'roots'),
		'id' => 'sidebar-footer-section-3',
		'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
		'after_widget' => '</div></section>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
	...
	register_sidebar(array(
		'name' => __('Footer Section 4', 'roots'),
		'id' => 'sidebar-footer-section-4',
		'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
		'after_widget' => '</div></section>',
		'before_title' => '<h3>',
		'after_title' => '</h3>',
