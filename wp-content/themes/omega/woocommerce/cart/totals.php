		...
		<table cellspacing="0">
			...
			<?php foreach ( $woocommerce->cart->get_fees() as $fee ) : ?>
				...
				<tr class="fee fee-<?php echo $fee->id ?>">
					<th><?php echo $fee->name ?>&nbsp;<a href="#" id="fee-tooltip" data-toggle="tooltip" title="Dry ice has been added to your cart because you selected one or more frozen items for purchase. This flat $30.00 charge will cover the cost of ice to ship up to a quantity of 25 x 500 mL serum bottles. For the most economical shipping arrangements possible, contact a sales representative or request a quote online." class="icon-question-sign"></a></th>
					<td><?php
